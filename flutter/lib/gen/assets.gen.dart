...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/admin_panel.svg
  SvgGenImage get adminPanel =>
      const SvgGenImage('assets/icons/admin_panel.svg');
  ...
  /// File path: assets/icons/communication.svg
  SvgGenImage get communication =>
      const SvgGenImage('assets/icons/communication.svg');
  ...
  /// File path: assets/icons/word.svg
  SvgGenImage get word => const SvgGenImage('assets/icons/word.svg');

  /// File path: assets/icons/xlsx.svg
  SvgGenImage get xlsx => const SvgGenImage('assets/icons/xlsx.svg');
