...
class GetDepartmentsQueryHandler extends IQueryHandler<GetDepartmentsQuery, List<Department>> {
  const GetDepartmentsQueryHandler({required this._departmentRepository});

  final IDepartmentRepository _departmentRepository;

  @override
  Future<Result<List<Department>>> handle(GetDepartmentsQuery query) async {
