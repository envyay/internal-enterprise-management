...
part of 'document_remote_data_source.dart';
...
class _DocumentRemoteDataSource implements DocumentRemoteDataSource {
  _DocumentRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ApiResponse<List<DocumentDto>>> getDocuments() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<DocumentDto>>>(
    ...
    late ApiResponse<List<DocumentDto>> _value;
    try {
      _value = ApiResponse<List<DocumentDto>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                  .map<DocumentDto>(
                    (i) => DocumentDto.fromJson(i as Map<String, dynamic>),
                  )
                  .toList()
            : List.empty(),
      );
  ...
  @override
  Future<ApiResponse<bool>> updateDocument(UpdateDocumentDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<bool>> deleteDocument(DeleteDocumentDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
