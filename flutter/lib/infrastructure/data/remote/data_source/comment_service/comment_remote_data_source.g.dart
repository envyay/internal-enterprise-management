...
part of 'comment_remote_data_source.dart';
...
class _CommentRemoteDataSource implements CommentRemoteDataSource {
  _CommentRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ApiResponse<List<CommentDto>>> getComments() async {
  ...
  @override
  Future<ApiResponse<bool>> updateComment(UpdateCommentDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
