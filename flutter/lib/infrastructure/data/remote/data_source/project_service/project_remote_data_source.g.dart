...
class _ProjectRemoteDataSource implements ProjectRemoteDataSource {
  ...
  @override
  Future<ApiResponse<ProjectDto?>> getProjectById(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    ...
    try {
      _value = ApiResponse<ProjectDto?>.fromJson(
        ...
        (json) => json == null
            ? null
            : ProjectDto.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
  ...
  @override
  Future<ApiResponse<List<TicketStatusDto>>> getTicketStatusesByProjectId(
    String id,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<List<UserDto>>> getUsersByProjectId(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ApiResponse<bool>> updateProject(UpdateProjectDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<bool>> setUsersInProject(SetUsersInProjectDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
